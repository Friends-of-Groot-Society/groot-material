...
import static xyz.cryptomaven.rest.security.SecurityConfig.passwordMaplEncoder;
...
//    }
    ...
    public String register(RegisterDto registerDto) {
        ...
        if(usersRepository.existsByUsername(registerDto.getUsername())){
            throw new ChainApiException(HttpStatus.BAD_REQUEST, "Username is already exists!.");
        }

        // add check for email exists in database
        if(usersRepository.existsByEmail(registerDto.getEmail())){
            throw new ChainApiException(HttpStatus.BAD_REQUEST, "Email is already exists!.");
        }
